...
**Note:** If no config is provided then the default config ([src/config.json](https://github.com/wiseplat/npm1-wiseplat-client-binaries/blob/master/src/config.json)) gets used.
